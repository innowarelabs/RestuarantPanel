...
const DEFAULT_CANCELLED_BY = 'Cancelled by Restaurant';
const DEFAULT_CANCEL_REASON = 'Item unavailable';

/**
 * Cancelled order: timeline (placed + cancelled), items, pricing, cancellation reason & payment handling.
 */
export default function CancelledOrderDrawer({ isOpen, onClose, order }) {
    ...
    const { subtotal, tax, platformFee, total, items, placedTime, cancelledTime, cancelledByLine, reasonLine, paymentIssuedTo, apiTimelineEvents, useApiTimeline } =
        ...
        return {
            ...
            cancelledTime: formatShortTime(order.updatedAt),
            cancelledByLine,
            reasonLine,
                        ...
                        {openSections.pricing && (
                            <div className="space-y-2 bg-white px-4 py-3">
                                ...
                                <div className="mt-1 rounded-lg border border-gray-100 bg-[#F6F8F9] p-3">
                                    ...
                                    <span
                                        className={`mt-0.5 block font-sans text-[13px] font-medium capitalize leading-[19.5px] tracking-normal ${
                        ...
                        {openSections.cancellation && (
                            <div className="space-y-3 bg-white px-4 py-3">
                                <div className="rounded-lg border border-[#FCA5A5] bg-[#FEF2F2] p-3">
                                    <p className="font-sans text-[13px] font-semibold leading-[19.5px] text-[#B91C1C]">
                                        {cancelledByLine}
                                    </p>
                                    <p className="mt-1 font-sans text-[12px] font-normal leading-[18px] text-[#B91C1C]">
                                        Reason: {reasonLine}
                                    </p>
                                </div>
                                <div className="rounded-lg bg-[#F3F4F6] p-3">
                                    <p className="font-sans text-[11px] font-normal leading-[16.5px] text-[#6B7280]">
                                        Payment Handling
                                    </p>
                                    <p className="mt-0.5 font-sans text-[13px] font-medium leading-[19.5px] text-[#0F1724]">
                                        Refund of {totalStr} issued to {paymentIssuedTo}
                                    </p>
                                </div>
                            </div>
                        )}
