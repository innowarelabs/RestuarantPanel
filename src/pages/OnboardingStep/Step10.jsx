...
const REVIEW_COL_RIGHT = ['Operational Info', 'Order Settings', 'Bank Details', 'Support Setup'];
        ...
        <div className="space-y-10">
            <div className="space-y-5">
                <p className="text-[15px] text-[#6B7280] leading-[1.6]">
                    Please review all the information you&apos;ve provided. You can click on previous steps in the
                    progress bar above to make changes, or click the button below to preview everything.
                </p>
                <button
                    type="button"
            ...
            <div className="flex flex-col sm:flex-row gap-4">
                <div className="flex-1 space-y-4">
                    {REVIEW_COL_LEFT.map((name) => (
                        <CompletedCard key={name} name={name} />
                    ))}
                </div>
                <div className="flex-1 space-y-4">
                    {REVIEW_COL_RIGHT.map((name) => (
                        <CompletedCard key={name} name={name} />
                    ))}
                </div>
            </div>

            <div className="bg-[#DD2F2626] border border-[#DD2F26]/20 p-5 rounded-[8px]">
                <p className="text-[14px] text-[#111827]">
                    <span className="font-[600]">Ready to go!</span> Click &quot;Complete Setup&quot; below to finish and access your
                    dashboard.
                </p>
            </div>
