...
import { DATE_RANGE_OPTIONS, dateRangeToDays } from '../../components/Reports/reportsFilterConstants';
...
function buildSalesReportQuery(f) {
...
function buildSalesReportPdf(data) {
    ...
    // Sales trend (from API when present)
